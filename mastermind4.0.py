...
def maingame():
    intro.win.destroy()
    global root
    root = Window('Mastermind (C)', bgcolor, fgcolor, None, '700x800', 'Παίζει ο παίκτης: {0} :: Ημ/νία: {1}. Επιλέξτε τα χρώματα απο τα combo box'.format(playername, datetime.datetime.now().strftime('%d-%m-%y')))
